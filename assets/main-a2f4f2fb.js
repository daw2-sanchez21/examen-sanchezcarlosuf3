...
const header = {
  template: `<h1>Carlos Sánchez</h1>`
};
const footer = {
  template: `<h3>Footer examen uf3</h3>`
};
const home = {
  template: `<h1>home</h1>`
};
...
const exform = {
  ...
  script: () => {
    ...
    form.addEventListener("submit", function(e) {
      ...
      sub.classList.remove("btn-warning");
      sub.classList.add("btn-success");
      e.preventDefault();
      cont++;
      console.log("clicks: " + cont);
      document.getElementById("Id-nombre");
      document.getElementById("Id-mesa");
      ...
      btneditar.addEventListener("click", function(r) {
        ...
        const sub2 = document.getElementById("Id-boton");
        sub2.textContent = "Actualizar";
        sub2.classList.remove("btn-success");
        sub2.classList.add("btn-warning");
        obtener2.forEach((o) => {
          o.remove();
        });
      });
