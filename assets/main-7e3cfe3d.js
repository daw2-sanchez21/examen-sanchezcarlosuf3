...
const form = {
  ...
  </form><div><div id="ficha"><h3>Datos del jugador</h3><ul id="datos"></ul></div>`,
  script: () => {
    console.log("Vista prueba cargada");
    const form2 = document.getElementById("form-id");
...
document.querySelector("main").innerHTML = form.template;
form.script();
